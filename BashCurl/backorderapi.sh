...
curl -X POST -H "Authorization: Bearer $token" -H "Content-Type: application/json" -d '["testdomain1.com","testdomain2.com"]'  https://www.dropcatch.com/api/BackorderDomainsApi/BackOrderDomains
